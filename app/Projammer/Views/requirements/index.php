...
<div ng-controller="RequirementsController">
	<table class="table">
		...
		<tbody>
			...
			<tr ng-form="form" ng-repeat="requirement in requirements">
				<input type="hidden" name="id" ng-model="requirement.id" />
				<input type="hidden" name="project_id" ng-model="requirement.project_id" />
				<td ng-class="{ 'has-error' : form.code.$invalid }" ><input class="form-control" type="text" required name="code" ng-model="requirement.code" ng-change="dirty(requirement)" /></td>
				<td ng-class="{ 'has-error' : form.name.$invalid }" ><input class="form-control" type="text" required name="name" ng-model="requirement.name" ng-change="dirty(requirement)" /></td>
			...
			<tr ng-form="newRequirementForm">
				<input type="hidden" name="project_id" ng-model="newRequirement.project_id" />
				<td><input class="form-control" type="text" name="code" ng-model="newRequirement.code" placeholder="code" ng-change="dirty(newRequirement)" /></td>
				<td><input class="form-control" type="text" name="name" ng-model="newRequirement.name" placeholder="requirement" ng-change="dirty(newRequirement)" /></td>
