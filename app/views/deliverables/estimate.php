...
<table class="table deliverable">
	...
	<? foreach ($deliverables as $d) { ?>
		<tr data-state="clean" data-monitor-state data-role="deliverable">
			...
			<td></td>
			<td><button data-role="save-deliverable" data-deliverable-id="<?= $d->id; ?>" type="button" data-monitored-button class="btn btn-default"><span class="glyphicon glyphicon-ok-sign"></span> </button></td>
		</tr>
	<? } ?>
		<tr>
			<input type="hidden" name="deliverable[]][display_order]" value="1000" data-role="display-order" />
